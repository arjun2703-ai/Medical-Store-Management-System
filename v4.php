...
echo "<tr><td>" . $row["VENDOR_NAME"]. "</td><td>" . $row["INVOICE_NO"]    . "</td><br><td>"
. $row["GST_NO"]. "</td><td>" .$row["P_RATE"] . "</td><td>" .$row["S_RATE"] . "</td><td>" .$row["QUANTITY"] . "</td><td>" .$row["STORE_ID"] . "</td><td>" .$row["DRUG_CODE"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
